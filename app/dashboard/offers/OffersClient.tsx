                            ...
                            <tbody className="divide-y divide-secondary-100">
                                {offers.map((offer) => (
                                    <OfferRow
                                        ...
                                        setSelectedOfferForCounter={setSelectedOfferForCounter}
                                    />
                                ))}
                            </tbody>
                        </table>
...
function OfferRow({
    ...
    handleRespond: (offerId: string, status: 'accepted' | 'rejected') => Promise<void>;
    setSelectedOfferForCounter: (offer: Offer) => void;
}) {
    ...
    return (
        <tr className="hover:bg-primary-50/10 transition group">
