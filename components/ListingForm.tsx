    ...
    useEffect(() => {
        if (mode === 'edit' && initialData) {
            setFormData({
                ...
                weight: initialData.weight_kg ? Number(initialData.weight_kg).toFixed(2) : (initialData.calculated_weight_kg ? Number(initialData.calculated_weight_kg).toFixed(2) : ''),
                ...
                postcode: initialData.postcode_area || '',
