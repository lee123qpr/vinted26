...
-- Adds support for user suspension, dispute resolution, and analytics
...
-- Allow users to view their own dispute messages
...
-- Allow users to insert messages in their disputes
...
-- Allow users to view evidence in their disputes
...
-- Allow users to upload evidence to their disputes
